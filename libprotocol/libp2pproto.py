...
PUT_FILE_IP_ADDR_INDEX = 1
PUT_FILE_PORT_INDEX = 2
PUT_FILE_MSG_TYPE_INDEX = 3

GET_FILE_OP_WORD = "GET"
GET_FILE_FILENAME_INDEX = 0
GET_FILE_IP_ADDR_INDEX = 1
GET_FILE_PORT_INDEX = 2
GET_FILE_MSG_TYPE_INDEX = 3

LIST_FILES_OP_WORD = "LIST"
LIST_FILES_FILE_STR_INDEX = 0
LIST_FILES_IP_ADDR_INDEX = 1
LIST_FILES_HOP_COUNT_INDEX = 2
